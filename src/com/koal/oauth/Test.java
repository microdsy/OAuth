...
//		Config config = OauthConfig.getOauthConfig(); //获取config对象
		...
		String result_token = oAuthController.getUserInfo("authorization_code", "mail", "userapp", "http://127.0.0.1", "126", "987", "ST-6-S7DjXhkmVauSMkiU4GOK-mail.test.com"); //获取token
